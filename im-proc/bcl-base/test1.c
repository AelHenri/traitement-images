 ...
 * @brief va mettre tous les canaux des pixels a 255 (blanc) puis dans une selection (via offset), va mettre le premier canal des pixels a 0. On obtient donc 0 255 255 (Cyan) dans la zone.
 */
